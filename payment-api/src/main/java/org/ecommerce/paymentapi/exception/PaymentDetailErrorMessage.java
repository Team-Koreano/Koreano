...
public class PaymentDetailErrorMessage {
	...
	public static final String NOT_NULL_ORDER_ITEM_ID = "주문상세ID를 전달해주세요";
	public static final String NOT_NULL_PAYMENT_AMOUNT = "주문금액을 전달해주세요";
	public static final String NOT_NULL_PRICE = "제품 가격을 전달해주세요";
	public static final String NOT_NULL_QUANTITY = "제품 수량을 전달해주세요";
	public static final String NOT_NULL_DELIVERY_FEE = "제품 배달료를 전달해주세요";
