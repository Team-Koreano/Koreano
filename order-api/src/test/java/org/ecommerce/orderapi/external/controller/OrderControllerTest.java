...
// 				new ArrayList<>()
// 		);
// 		when(orderDomainService.placeOrder(anyInt(), any(OrderDto.Request.Place.class)))
// 				.thenReturn(orderDto);
//
// 		// when
// 		// then
...
// 				)
// 		);
// 		given(orderDomainService.getOrders(userId, year, pageNumber))
...
// 				)
// 		);
// 		given(orderDomainService.getOrderStatusHistory(anyLong()))
...
// 		mockMvc.perform(get("/api/external/orders/v1{orderId}/orderItems/{orderItemId}/statusHistory\""))
// 				.andDo(print())
...
// 				LocalDateTime.of(2024, 5, 8, 0, 0)
// 		);
// 		given(orderDomainService.cancelOrder(anyInt(), anyLong()))
...
// 				.andExpect(
// 						jsonPath("$.result.productId").value(orderItemDto.getProductId()))
// 				.andExpect(jsonPath("$.result.productName").value(
// 						orderItemDto.getProductName()))
// 				.andExpect(jsonPath("$.result.price").value(orderItemDto.getPrice()))
// 				.andExpect(
// 						jsonPath("$.result.quantity").value(orderItemDto.getQuantity()))
// 				.andExpect(jsonPath("$.result.totalPrice").value(
// 						orderItemDto.getTotalPrice()))
// 				.andExpect(jsonPath("$.result.paymentAmount").value(
// 						orderItemDto.getPaymentAmount()))
// 				.andExpect(
// 						jsonPath("$.result.sellerId").value(orderItemDto.getSellerId()))
// 				.andExpect(jsonPath("$.result.sellerName").value(
// 						orderItemDto.getSellerName()))
// 				.andExpect(jsonPath("$.result.status").value(
// 						orderItemDto.getStatus().toString()))
// 				.andExpect(jsonPath("$.result.statusReason").value(
