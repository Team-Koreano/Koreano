...
public enum OrderErrorCode implements ErrorCode {
	...
	MUST_OPEN_ORDER_TO_APPROVE(HttpStatus.BAD_REQUEST.value(),
			"주문을 승인하려면 주문 상태가 OPEN 여야 합니다."),
	MUST_OPEN_ORDER_ITEM_TO_APPROVE(HttpStatus.BAD_REQUEST.value(),
			"주문항목을 승인하려면 주문 상태가 OPEN 여야 합니다."),
